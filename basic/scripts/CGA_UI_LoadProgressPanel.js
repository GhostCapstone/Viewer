...
CGA_UI_LoadProgressPanel.prototype.hide = function ()
{
...
CGA_UI_LoadProgressPanel.prototype.objectLoadProgress = function (loaderId, loaded, started)
{
    console.progress("Progress: " + loaded + " / " + started);
...
// Show the UI
CGA_UI_LoadProgressPanel.prototype.show = function ()
{
